...
# Bu script tüm frontend dosyalarını otomatik oluşturur

echo "🚀 ExportHunter AI - Frontend Oluşturuluyor..."
echo ""
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">ExportHunter AI</h1>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          🇹🇷 Made with ❤️ in Turkey for Turkish Exporters
        </p>
      </div>
    </div>
  )
...
echo "✅ Frontend components oluşturuldu!"
echo "✅ Login & Register pages hazır!"
echo ""
echo "📦 Şimdi npm install çalıştır:"
echo "  cd frontend && npm install"
EOF

chmod +x /mnt/user-data/outputs/exporthunter-ai/CREATE_FRONTEND_FILES.sh
